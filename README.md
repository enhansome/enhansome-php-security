...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 431 | 🐛 2 | 🌐 Java | 📅 2026-09-08 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,961 | 🐛 0 | 🌐 Java | 📅 2026-09-07 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,625 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
