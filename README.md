...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 432 | 🐛 4 | 🌐 Java | 📅 2026-09-21 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 11,004 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,701 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,040 | 🐛 22 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 473 | 🐛 1 | 📅 2024-02-22.
