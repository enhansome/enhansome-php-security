...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,605 | 🐛 105 | 📅 2026-08-21 list thing.*
...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 431 | 🐛 4 | 🌐 Java | 📅 2026-08-31 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,941 | 🐛 0 | 🌐 Java | 📅 2026-08-28 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [progpilot](https://github.com/designsecurity/progpilot) ⭐ 367 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 - A static analyzer for security purposes.
...
* [roave/security-advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-08-28 - Add this dependency to disallow known/vulnerable installation of packages directly through `composer update`
* [Security Advisories](https://github.com/FriendsOfPHP/security-advisories) ⭐ 2,140 | 🐛 3 | 🌐 PHP | 📅 2026-08-28 - A database of PHP security advisories.
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,580 | 🐛 7 | 🌐 PHP | 📅 2026-08-19 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
* [Awesome-AppSec: PHP-Section](https://github.com/paragonie/awesome-appsec#php) ⭐ 7,046 | 🐛 42 | 🌐 PHP | 📅 2025-02-22
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,033 | 🐛 13 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 474 | 🐛 1 | 📅 2024-02-22.
