...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 431 | 🐛 2 | 🌐 Java | 📅 2026-08-25 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,925 | 🐛 0 | 🌐 Java | 📅 2026-08-25 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [roave/security-advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-08-25 - Add this dependency to disallow known/vulnerable installation of packages directly through `composer update`
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,547 | 🐛 8 | 🌐 PHP | 📅 2026-08-19 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,027 | 🐛 11 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 474 | 🐛 1 | 📅 2024-02-22.
