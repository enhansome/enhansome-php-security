...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,567 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 432 | 🐛 3 | 🌐 Java | 📅 2026-09-16 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,987 | 🐛 0 | 🌐 Java | 📅 2026-09-15 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,673 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
* [Awesome-AppSec: PHP-Section](https://github.com/paragonie/awesome-appsec#php) ⭐ 7,058 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
