...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,042 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 432 | 🐛 4 | 🌐 Java | 📅 2026-09-18 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 11,000 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [roave/security-advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,917 | 🐛 1 | 📅 2026-09-18 - Add this dependency to disallow known/vulnerable installation of packages directly through `composer update`
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,692 | 🐛 7 | 🌐 PHP | 📅 2026-09-07 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
* [Awesome-AppSec: PHP-Section](https://github.com/paragonie/awesome-appsec#php) ⭐ 7,062 | 🐛 42 | 🌐 PHP | 📅 2025-02-22
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,039 | 🐛 22 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 473 | 🐛 1 | 📅 2024-02-22.
