...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,702 | 🐛 106 | 📅 2026-08-21 list thing.*
...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 431 | 🐛 2 | 🌐 Java | 📅 2026-08-24 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,920 | 🐛 0 | 🌐 Java | 📅 2026-08-24 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [roave/security-advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-08-21 - Add this dependency to disallow known/vulnerable installation of packages directly through `composer update`
* [Security Advisories](https://github.com/FriendsOfPHP/security-advisories) ⭐ 2,139 | 🐛 3 | 🌐 PHP | 📅 2026-08-18 - A database of PHP security advisories.
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,538 | 🐛 8 | 🌐 PHP | 📅 2026-08-19 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
* [Awesome-AppSec: PHP-Section](https://github.com/paragonie/awesome-appsec#php) ⭐ 7,040 | 🐛 40 | 🌐 PHP | 📅 2025-02-22
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,026 | 🐛 11 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 474 | 🐛 1 | 📅 2024-02-22.
