...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,198 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [SonarPHP](https://github.com/SonarSource/sonar-php) ⭐ 431 | 🐛 4 | 🌐 Java | 📅 2026-09-02 from [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,945 | 🐛 0 | 🌐 Java | 📅 2026-09-02 - A static code analyser for PHP language used as an extension for the SonarQube platform (200+ rules, Supports up to PHP 8, Import of unit test and coverage results, Support of custom rules)
...
* [roave/security-advisories](https://github.com/Roave/SecurityAdvisories) ⭐ 2,914 | 🐛 1 | 📅 2026-09-01 - Add this dependency to disallow known/vulnerable installation of packages directly through `composer update`
...
* [DVWA](https://github.com/ethicalhack3r/DVWA) ⭐ 13,587 | 🐛 7 | 🌐 PHP | 📅 2026-08-19 - Damn Vulnerable Web Application (DVWA) is a PHP/MySQL web application that is damn vulnerable.
...
* [Awesome-AppSec: PHP-Section](https://github.com/paragonie/awesome-appsec#php) ⭐ 7,052 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
...
This awesome list was inspired by [awesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,036 | 🐛 14 | 📅 2026-08-14 and [awesome-ruby-security](https://github.com/pxlpnk/awesome-ruby-security) ⭐ 474 | 🐛 1 | 📅 2024-02-22.
